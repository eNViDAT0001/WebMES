              ...
              {listProductInBrand.length === 0 ? (
                ...
                listProductInBrand.map((row) => (
                  <StyledTableRow key={row.id}>
                    ...
                    >
                      <img
                        src={!(row.Media)? noImgAvailable :row.Media[0].mediaPath}
                        alt="Anh san pham"
                    ...
                    <StyledTableCell align="center" sx={{ width: 20, padding: 1 }}>
