...
const DetailInformation = () =>{
    return(
    <div className="w-full h-649px mt-50px bg-gray-product-detail-information border flex justify-center">
        <div className="w-full h-full p-20">
        <div className=" flex flex-col">
            <div className="flex flex-row text-2xl text-purple-text">
                <h1 className="hover:underline">Description</h1>
                <h1 className= "ml-76px hover:underline focus:underline">Reviews</h1>
            </div>  
