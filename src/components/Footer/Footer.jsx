...
const Footer = () => {
  return (
    <div className="bg-gray-900 text-white">
        ...
        <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] pt-7">
            <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5">
                <span className="text-teal-400">MES</span> always with you
            </h1>
            <div>
                <input type="text" placeholder="Enter..." className="text-gray-800 sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 rounded px-2 focus:outline-none"></input>
